...
// generatePassword(length?, includeUppercase?, includeLowercase?,
// includeDigits?, includeSymbols?, excludeAmbiguous?). Deliberately does NOT
// expose vault/folder creation — nmhost only ever opens a vault the GUI
// already created.
